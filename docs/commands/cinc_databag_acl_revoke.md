...
```
cinc databag acl revoke <perm> <name> [flags]
```

### Examples

Revoke a user's update access on databag secrets.

```bash
cinc databag acl revoke update secrets --user alice
```
