...
* [cinc group acl grant](cinc_group_acl_grant.md)	 - Add members to a permission
* [cinc group acl revoke](cinc_group_acl_revoke.md)	 - Remove members from a permission
* [cinc group acl show](cinc_group_acl_show.md)	 - Show the full ACL
