...
```
cinc client acl grant <perm> <name> [flags]
```

### Examples

Grant a group read access to client worker-01.

```bash
cinc client acl grant read worker-01 --group admins
```
