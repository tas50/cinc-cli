...
```
cinc client acl revoke <perm> <name> [flags]
```

### Examples

Revoke a user's update access on client worker-01.

```bash
cinc client acl revoke update worker-01 --user alice
```
...
* [cinc client acl](cinc_client_acl.md)	 - Manage the ACL of a client
