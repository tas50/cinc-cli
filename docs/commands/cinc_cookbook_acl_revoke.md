...
```
cinc cookbook acl revoke <perm> <name> [flags]
```

### Examples

Revoke a user's update access on cookbook nginx.

```bash
cinc cookbook acl revoke update nginx --user alice
```
