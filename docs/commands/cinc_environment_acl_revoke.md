...
```
cinc environment acl revoke <perm> <name> [flags]
```

### Examples

Revoke a user's update access on environment prod.

```bash
cinc environment acl revoke update prod --user alice
```
