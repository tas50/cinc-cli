...
```
cinc databag acl grant <perm> <name> [flags]
```

### Examples

Grant a group read access to databag secrets.

```bash
cinc databag acl grant read secrets --group admins
```
