...
```
cinc environment acl grant <perm> <name> [flags]
```

### Examples

Grant a group read access to environment prod.

```bash
cinc environment acl grant read prod --group admins
```
