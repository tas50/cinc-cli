...
```
cinc cookbook acl grant <perm> <name> [flags]
```

### Examples

Grant a group read access to cookbook nginx.

```bash
cinc cookbook acl grant read nginx --group admins
```
