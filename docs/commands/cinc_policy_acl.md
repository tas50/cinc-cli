...
* [cinc policy acl grant](cinc_policy_acl_grant.md)	 - Add members to a permission
* [cinc policy acl revoke](cinc_policy_acl_revoke.md)	 - Remove members from a permission
* [cinc policy acl show](cinc_policy_acl_show.md)	 - Show the full ACL
