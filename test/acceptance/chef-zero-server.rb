...
# /organizations/<org>/... routes, creates ORG, and seeds it with a small
# fixed set of nodes. Runs in the foreground until it receives SIGINT or
# SIGTERM. Prints "READY" once the server is serving requests.
...
server.load_data({ "nodes" => { "web01" => {}, "web02" => {}, "db01" => {} } }, org)
